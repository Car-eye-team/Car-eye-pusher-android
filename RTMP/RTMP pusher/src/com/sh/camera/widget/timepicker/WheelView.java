...
public class WheelView extends View {
	...
	public int TEXT_SIZE_ITEM_PAINT;
	public int TEXT_SIZE_VALUE_PAINT;
	...
	private void initResourcesIfNecessary() {
		if (itemsPaint == null) {
			...
			if(TEXT_SIZE_ITEM_PAINT != 0){
				itemsPaint.setTextSize(TEXT_SIZE_ITEM_PAINT);
			}else{
		...
		if (valuePaint == null) {
			...
			if(TEXT_SIZE_VALUE_PAINT != 0){
				valuePaint.setTextSize(TEXT_SIZE_VALUE_PAINT);
			}else{
